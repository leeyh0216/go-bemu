...
type disabledMainQueryOperations struct{}

func (disabledMainQueryOperations) AnalyzeQueryOperation(
	context.Context,
	ports.QueryRequest,
...
func (disabledMainQueryOperations) VerifyQueryOperation(ports.QueryRequest, ports.QueryOperation) error {
	return fmt.Errorf("%w: disabled semantic query operation", domain.ErrPrecondition)
}

func (disabledMainQueryOperations) ExecuteQueryOperation(
	context.Context,
	ports.QueryRequest,
...
func (disabledMainQueryOperations) WithCanonicalTables(
	context.Context,
...
func newMainTestQueryService(
	...
	disabled := disabledMainQueryOperations{}
