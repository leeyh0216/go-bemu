...
func validateAxes(location string, axes MatrixAxes) error {
	allowed := map[string]map[string]bool{
		...
		"parallelism":       stringSet("read-stream-1", "read-stream-2", "read-stream-4", "read-stream-negotiated", "spark-partition-1", "spark-partition-2", "spark-partition-4", "spark-partition-negotiated", "not-applicable"),
