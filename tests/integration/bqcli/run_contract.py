...
@operation("bigquery.projects.list", scenario="bq-metadata")
@operation("bigquery.datasets.insert", scenario="bq-metadata")
@operation("bigquery.datasets.get", scenario="bq-metadata")
@operation("bigquery.datasets.delete", scenario="bq-metadata")
@operation("bigquery.tables.insert", scenario="bq-metadata")
@operation("bigquery.tables.get", scenario="bq-metadata")
@operation("bigquery.tables.patch", scenario="bq-metadata")
@operation("bigquery.tables.list", scenario="bq-metadata")
@operation("bigquery.tables.delete", scenario="bq-metadata")
