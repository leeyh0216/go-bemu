...
// GCSObjectURI is the validated, immutable identity of one load source or
// source pattern. Transport and object-store adapters share this parser so the
// public admission rule cannot drift from outbound request routing.
