...
func TestValidateConfigurationAcceptsOnlyGCSObjectURIs(t *testing.T) {
	...
	for name, source := range map[string]string{
		"empty": "", "bare path": "/tmp/input.parquet", "file": "file:///tmp/input.parquet",
		"HTTP": "https://storage.example/input.parquet", "missing bucket": "gs:///input.parquet",
		"missing object": "gs://bucket", "query": "gs://bucket/input.parquet?generation=1",
