...
func TestWarehousePublishesPortableSchemaCapabilities(t *testing.T) {
	...
	if capabilities.MaxDecimalPrecision != 38 || capabilities.MaxDecimalScale != 38 ||
		...
		!capabilities.TableSchemaChanges.AddColumn || !capabilities.TableSchemaChanges.DropColumn ||
		!capabilities.TableSchemaChanges.RenameColumn || !capabilities.TableSchemaChanges.AlterColumnType ||
		!capabilities.TableSchemaChanges.Transactional || !capabilities.TableSchemaChanges.InspectBeforeAfter {
