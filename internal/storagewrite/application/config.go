...
// 3.22.1 used by spark-bigquery-connector 0.44.2 reports a 20 MiB API maximum;
// the connector batches at 95 percent of that value.
// https://repo1.maven.org/maven2/com/google/cloud/google-cloud-bigquerystorage/3.22.1/google-cloud-bigquerystorage-3.22.1-sources.jar
